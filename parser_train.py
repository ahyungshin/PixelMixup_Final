...
def parser_(parser):
    ...
    #model
    parser.add_argument('--resume_path', type=str, default='./pretrained/from_gta5_to_cityscapes_on_deeplabv2_best_model.pkl', help='resume model path')
    ...
    parser.add_argument('--src_rootpath', type=str, default='/local_datasets/GTA5')
    parser.add_argument('--tgt_rootpath', type=str, default='/local_datasets/CityScapes')
