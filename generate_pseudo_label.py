...
def validate(valid_loader, device, model, opt):
    ori_LP = os.path.join(opt.save_path, opt.name)
...
#python generate_pseudo_label.py --name gta2citylabv2_warmup_soft --soft --resume_path ./pretrained/from_gta5_to_cityscapes_on_deeplabv2_best_model.pkl --no_droplast
